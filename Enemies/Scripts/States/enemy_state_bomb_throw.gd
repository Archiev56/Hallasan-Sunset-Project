class_name EnemyStateBombThrow extends EnemyState

@export_category("AI")

@export var anim_name: String = "shoot"
@export var BOMB_SCENE: PackedScene = preload("res://Hallasan-Sunset/Player/Technical/Moves/Projectile copy/arc_projectile.tscn")
...
func shoot_orb() -> void:
	var eb: Node2D = BOMB_SCENE.instantiate()
