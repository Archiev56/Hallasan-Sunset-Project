...
@onready var audio_activate : AudioStream = preload("res://Hallasan-Sunset/Environment/Dungeon/Dungeon_elements/Audio/lever-01.wav")
@onready var audio_deactivate : AudioStream = preload("res://Hallasan-Sunset/Environment/Dungeon/Dungeon_elements/Audio/lever-02.wav")
