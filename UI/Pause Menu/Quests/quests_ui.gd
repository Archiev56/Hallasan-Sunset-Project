...
const QUEST_ITEM : PackedScene = preload("res://Hallasan-Sunset/UI/Pause Menu/Quests/quest_item.tscn")
const QUEST_STEP_ITEM : PackedScene = preload("res://Hallasan-Sunset/UI/Pause Menu/Quests/quest_step_item.tscn")
