...
@onready var sprite_node = $"../Sprite2D"  # Change this to the correct sprite node path
...
func instance_ghost():
	...
	if sprite_node:
		var current_texture = sprite_node.texture
...
func _on_duration_timer_timeout():
	print("Dash ended")
	ghost_timer.stop()  # Stop ghost creation when the dash ends
