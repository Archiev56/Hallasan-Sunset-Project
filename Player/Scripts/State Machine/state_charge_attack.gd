...
@onready var charge_hurt_box: HurtBox = $"../../Interactions/ChargeHurtBox"
@onready var charge_spin_hurt_box = $"../../Interactions/ChargeSpinHurtBox"
...
@onready var gpu_particles_2d: GPUParticles2D = $"../../Interactions/ChargeHurtBox/GPUParticles2D"
